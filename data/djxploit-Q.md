## Dependence on block.number and block.timestamp is risky, as they can be manipulated by miners
...
https://github.com/jbx-protocol/juice-nft-rewards/blob/f9893b1497098241dd3a664956d8016ff0d0efd0/contracts/abstract/JB721Delegate.sol#L203-L213

AS it can be called by anyone, so it is vulnerable to front-running. Attacker can provide more gas to front-run it
